<template>
  ...
  <div class="vmain">
    <div class="vtitle">
      ...
      <div class="right">
        <div class="like" @click="updateLike">
          赞({{ likes.length | number }})
        </div>
        <div class="comment" v-if="allowcomment" @click="openPopup">
    ...
    <div class="likes" v-if="likes.length > 0">
      <div class="tags">
        <el-image class="zanimg" :src="baseAppUrl + `zan.png`"></el-image>
        <div class="zantxt">赞</div>
      </div>
      <div class="holder">
    ...
    <div class="comments" v-loading="loading" v-if="allowcomment">
      <div class="tags">
  ...
  methods: {
    ...
    getLikes() {
      ...
      getLikesApi({
        ...
        msg.forEach(item => {
          if (item.user__thumbnail_portait) {
