  ...
  <div>
    <el-form :model="addProductsForm" status-icon ref="addProductsForm" label-width="90px">
      <div style="display:flex">
        ...
        <div>
          <div style="display:flex"> 
            <el-cascader v-model="category" placeholder="请选择类别" 
            ...
            <el-checkbox v-model="recommend"  class="book">设为推荐民宿</el-checkbox>
            <el-checkbox v-model="shopcard"  class="book">民宿类别</el-checkbox>
            <el-radio v-model="cardtype" class="cardtype"   :label="0">电子卡</el-radio>
            <el-radio v-model="cardtype"  class="cardtype"   :label="1">实物卡</el-radio>
            
          </div>
          <div class="title">房价设置:</div>
          <div style="display:flex">  
            <el-form-item label="工作日价格:" prop="workday_price">
              <el-input v-model="addProductsForm.workday_price" class="price" type="number"></el-input>
            </el-form-item>  
            <el-form-item label="周末价格:" prop="weekday_price">
              <el-input v-model="addProductsForm.weekday_price" class="price"  type="number"></el-input>
            </el-form-item>  
            <el-form-item label="节假日价格:" prop="holiday_price">
              <el-input v-model="addProductsForm.holiday_price" class="price"  type="number"></el-input>
            </el-form-item>  
            <div class="pricetype">
              <el-radio v-model="cardtype" class="cardtype"   :label="0">仅覆盖日历上未设定价格的日期</el-radio>
              <el-radio v-model="cardtype" class="cardtype"   :label="1">覆盖日历所有价格</el-radio>
            </div>
          </div>
          <div class="calendars">
            <Calendar  ></Calendar>
            <el-collapse  >
              <el-collapse-item title="价格日历:"   
              name="1" > 
              </el-collapse-item> 
            </el-collapse>
          </div>
          ...
          <div class="table">
            ...
            >
              ...
              <el-table-column label="民宿数量">
                <template slot-scope="scope">
                  <el-input v-model.number="scope.row.number"></el-input>
                </template>
              </el-table-column>
              <el-table-column label="民宿规格">
                <template slot-scope="scope">
...
<style lang='scss'      >
@import "/node_modules/vue-simple-calendar/static/css/style.css";
