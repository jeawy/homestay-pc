...
//修改注册用户信息
export function editCommunityUserDetail(params) {
  return AXIOS.post('/users/community/?put', params)
}
...
//获取用户管理权限
export function getUserPerfession(params) {
  return AXIOS.get('/users/list/?auth',{params})
}
//角色列表
export function getRoles(params) {
  return AXIOS.get('/role/role/?list',{params})
}
